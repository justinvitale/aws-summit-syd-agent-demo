 ...
 *
 * The cookie is maintained on the client by RecentlyViewedTracker, which
 * writes it on every product detail mount, so by the time this reader
 * runs the cookie is always present.
 */
